...
/**
 * Width of the DOM box drei lays out, in CSS px — also the screen's effective resolution,
 * so it stays at the authored design width. The height comes from the mesh's aspect.
 */
const SCREEN_BOX_WIDTH = 1920;
/** The lid quad lies in the XZ plane; rotate the DOM's XY plane onto it. */
...
export function Macbook(props: JSX.IntrinsicElements["group"]) {
  ...
  // Placement comes from the display mesh itself rather than tuned constants, so the
  // HTML always lands on the screen even if the model changes.
  const screenGeometry = nodes.Circle002_4.geometry;
